                            ...
                            <div class="metrics-timeline">
                                ...
                                <div class="row">
                                    ...
                                    @if (!empty($data['metrics']['customer_satisfaction']))
                                        <div class="col-md-6 mb-3">
                                            <div class="metric-item text-center">
                                                <div class="metric-value">{{ $data['metrics']['customer_satisfaction'] }}%
                                                </div>
                                    ...
                                    <div class="certification-details">
                                        @if (!empty($certification['issue_date']))
                                            <p><strong>Issued:</strong>
                                                {{ \Carbon\Carbon::parse($certification['issue_date'])->format('M d, Y') }}
                                            </p>
                                        @endif
                                        @if (!empty($certification['expiry_date']))
                                            <p><strong>Expires:</strong>
                                                {{ \Carbon\Carbon::parse($certification['expiry_date'])->format('M d, Y') }}
                                            </p>
                                        @endif
                                    </div>
                                </div>
