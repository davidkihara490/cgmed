    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <a class="float-end btn btn-success btn-sm" href="{{ route('sections.create') }}">New</a>
            </div>
            <div class="card-body">
                        ...
                        @foreach ($sections as $section)
                            ...
                            <td>{{ $section->name }} </td>
                                ...
                                <td class="text-end">
                                    ...
                                    {{-- <a href="{{ route('sections.view', $section->id) }}"
                                        class="btn btn-success btn-sm">View</a> --}}
                                    <button type="button" class="btn btn-danger btn-sm"
                                        wire:click="confirm({{ $section->id }})">
                                        Delete
                                    </button>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Are you sure you want to delete this section? This operation is not
                                                reversible.</p>
                                        </div>
